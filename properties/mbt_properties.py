...
class MBTToolPanelPG(bpy.types.PropertyGroup):
    ...
    def getMHWorldBoneList(self, context):
        return reloadPresets("MHWorld")

    MHWorldBoneList: EnumProperty(
        name="",
        description="Dictionary for snapping bones and renaming vertex groups",
        items=getMHWorldBoneList
    )
