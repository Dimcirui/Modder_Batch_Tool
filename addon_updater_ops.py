...
updater.addon = "modder_batch_tool"
...
def register(bl_info):
    ...
    updater.repo = "Modder_Batch_Tool"

    # updater.addon = # define at top of module, MUST be done first

    # Website for manual addon download, optional but recommended to set.
    updater.website = "https://github.com/Dimcirui/Modder_Batch_Tool"
    ...
    updater.overwrite_patterns = ["*.png","*.py","*.json", "*.jpg", "README.md", "LICENSE.txt", "*.fbx", "*.7", "*.mod3"]
    ...
    updater.remove_pre_update_patterns = ["*.pyc", "*.fbx", "*.7", "*.mod3"]
