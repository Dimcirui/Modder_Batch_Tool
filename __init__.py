import bpy
import os
from .games.MHWorld import auto_process
from . import games
...
# Blender 4.2 extensions clear bl_info from the module namespace before calling
# register(), so keep a copy for addon_updater which needs it at register time.
...
def register():
    ...
    addon_updater_ops.register(_bl_info)
    ...
    try:
        ...
        print(f"Warning: games register failed: {e}")
        import traceback
        traceback.print_exc()
